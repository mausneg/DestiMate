...
import com.capstone.destimate.databinding.ItemNearbyBinding
import com.capstone.destimate.view.detail.DetailActivity

class ListNearbyAdapter: ListAdapter<Destination, ListNearbyAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    class MyViewHolder(private val binding: ItemNearbyBinding) :
        RecyclerView.ViewHolder(binding.root){
        fun bind(destination: Destination){
            binding.apply {
                tvItemName.text = destination.placeName

                Glide.with(imgItemPreview.context)
                ...
                cvItemNearby.setOnClickListener{
                    val intentDetail = Intent(cvItemNearby.context, DetailActivity::class.java)
                    intentDetail.putExtra("extra_destination", destinationParcel)
                    cvItemNearby.context.startActivity(intentDetail)
                }
            }
        }
    }
